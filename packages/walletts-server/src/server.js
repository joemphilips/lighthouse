...
var walletts_main_1 = require("walletts-main");
var container_1 = require("walletts-main/container");
...
var WalletServer = /** @class */ (function () {
    function WalletServer(opts) {
        this.cfg = walletts_main_1.loadConfig(opts);
        this.walletdb = container_1.container.resolve('WalletDB');
        this.wallet = container_1.container.resolve("Wallet");
        this.server = container_1.container.resolve("RPCServer");
    }
    WalletServer.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.wallet.load(this.cfg.walletDBPath)];
                    case 1:
                        _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
